  ...
  return (
    <Grid style={balanceStyle.table}>
      ...
      <Col size={50}>
        ...
        <Row style={balanceStyle.rightCell}>
          <Text style={balanceStyle.text}>
            {dolarConvert(turista.venta, number)}
          </Text>
        </Row>
        <Row style={balanceStyle.rightCell}>
          <Text style={balanceStyle.text}>
            {dolarConvert(blue.venta, number)}
          </Text>
        </Row>
        <Row style={balanceStyle.rightCell}>
          <Text style={balanceStyle.text}>
            {dolarConvert(ccl.venta, number)}
          </Text>
        </Row>
        <Row style={balanceStyle.rightCell}>
          <Col size={25}>
